 ...
 */
const std::string GEM::Managers::InputManager::LOGGER_NAME = INPUT_MANAGER_LOGGER_NAME;
 ...
 */
std::map<GLFWwindow* const, std::shared_ptr<GEM::Managers::InputManager>> GEM::Managers::InputManager::inputManagerPtrCallbackMap;
 ...
 */
std::map<GLFWwindow* const, GEM::Managers::InputManager::CallbackHelper::CursorPosition> GEM::Managers::InputManager::CallbackHelper::lastCursorPositionMap;
 ...
 * @return std::shared_ptr<GEM::Managers::InputManager> The shared pointer to the InputManager
 */
std::shared_ptr<GEM::Managers::InputManager> GEM::Managers::InputManager::createPtr(GLFWwindow* const p_glfwWindow) {
    ...
    if (GEM::Managers::InputManager::inputManagerPtrCallbackMap.count(p_glfwWindow) > 0) {
    ...
    {
        // Let's create one
        GEM::Managers::InputManager inputManager(p_glfwWindow);

        // Input it for fuure use
        GEM::Managers::InputManager::inputManagerPtrCallbackMap.insert({
            p_glfwWindow,
            std::make_shared<GEM::Managers::InputManager>(std::move(inputManager))
        });
    }
    ...
    glfwSetCursorPosCallback(p_glfwWindow, GEM::Managers::InputManager::CallbackHelper::cursorPositionInputCallback);
    glfwSetScrollCallback(p_glfwWindow, GEM::Managers::InputManager::CallbackHelper::scrollInputCallback);

    // Use the newly created one
    std::shared_ptr<GEM::Managers::InputManager> p_inputManager = GEM::Managers::InputManager::inputManagerPtrCallbackMap[p_glfwWindow];
 ...
 * @return std::shared_ptr<GEM::Managers::InputManager> The shared pointer to the already created InputManager
 */
std::shared_ptr<GEM::Managers::InputManager> GEM::Managers::InputManager::getPtr(GLFWwindow* const p_glfwWindow) {
    ...
    // Use the newly created one
    return GEM::Managers::InputManager::inputManagerPtrCallbackMap[p_glfwWindow];
}

/**
 * @brief Clear the maps of the input manager pointers
 */
void GEM::Managers::InputManager::clean() {
    LOG_TRACE("Clearing InputManager maps");
    GEM::Managers::InputManager::inputManagerPtrCallbackMap.clear();
}
 ...
 */
void GEM::Managers::InputManager::CallbackHelper::cursorPositionInputCallback(GLFWwindow* p_glfwWindow, double currCursorXPos, double currCursorYPos) {
    ...
    if (GEM::Managers::InputManager::CallbackHelper::lastCursorPositionMap.count(p_glfwWindow) == 0) {
        ...
        GEM::Managers::InputManager::CallbackHelper::lastCursorPositionMap.insert({
            p_glfwWindow,
    ...
    GEM::Managers::InputManager::CallbackHelper::CursorPosition lastPosition = GEM::Managers::InputManager::CallbackHelper::lastCursorPositionMap[p_glfwWindow];
    ...
    GEM::Managers::InputManager::CallbackHelper::lastCursorPositionMap[p_glfwWindow] = {
 ...
 */
void GEM::Managers::InputManager::CallbackHelper::scrollInputCallback(GLFWwindow* p_glfwWindow, double scrollXOffset, double scrollYOffset) {
    // Get the instance corresponding to this glfw window pointer
    std::shared_ptr<GEM::Managers::InputManager> p_inputManager = GEM::Managers::InputManager::getPtr(p_glfwWindow);
...
/**
 * @brief Destroy the GEM::Managers::InputManager::InputManager object
 */
GEM::Managers::InputManager::~InputManager() {
 ...
 */
void GEM::Managers::InputManager::collectInput() {
...
/**
 * @brief Construct a new GEM::Managers::InputManager::InputManager object from a given context
 * 
 * @param p_glfwWindow The context for which the input manager will be responsible
 */
GEM::Managers::InputManager::InputManager(GLFWwindow* const p_glfwWindow) :
